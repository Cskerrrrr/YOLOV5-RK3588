...
def run(weights='./best.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default='runs/train/640x640-EXP/weights/best.pt', help='weights path')
    parser.add_argument('--img-size', nargs='+', type=int, default=[IMAGE_SIZE, IMAGE_SIZE], help='image (height, width)')
    ...
    parser.add_argument('--opset', type=int, default=12, help='ONNX: opset version')#13 to 12
